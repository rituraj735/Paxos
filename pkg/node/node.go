...
// clusterMajorityLocked computes majority based on the fixed cluster size,
// not the number of currently active nodes. Liveness checks are done
// separately before proposing/committing.
